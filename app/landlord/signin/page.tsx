  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (profileData.role !== 'landlord') {
        // Sign out the user if they're not a landlord
        await supabase.auth.signOut()
        throw new Error('Please use the student portal to sign in')
      }
        ...
        <Card className="backdrop-blur-sm bg-card/95 shadow-2xl border-0 ring-1 ring-border/50">
          <CardHeader className="text-center pb-8">
            ...
            <CardDescription className="text-base mt-2">
              Welcome back! Sign in to manage your properties and tenants.
            </CardDescription>
          </CardHeader>
